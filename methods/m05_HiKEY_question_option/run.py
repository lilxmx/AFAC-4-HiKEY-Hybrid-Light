#!/usr/bin/env python3
"""Entry point for m05_HiKEY_question_option."""
import argparse
import logging
import sys
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=f"{METHOD_NAME}: HiKEY question+option retrieval"
    )
    ...
    from pipeline import HiKEYQuestionOptionPipeline

    domains = args.domains or DOMAINS
    pipeline = HiKEYQuestionOptionPipeline()
